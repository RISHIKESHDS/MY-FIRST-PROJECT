...
api_key = 'AIzaSyDN0LUY6uhJHZ6qTZqE36GmB1m3s5hzo6E'
...
def main():
    try:
        ...
        st.title(":red[YouTube Channel Information]")
        ...
        selected_channel = st.selectbox(":green[Select a channel]", channel_names)
        ...
        query_selected = st.selectbox(":green[Select a query:]", list(queries.keys()))
